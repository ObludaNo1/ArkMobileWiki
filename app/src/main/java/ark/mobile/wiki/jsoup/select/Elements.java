...
public class Elements extends ArrayList<Element> {
    ...
    /**
     ...
     becomes {@code <p><i><b>This</b></i> is <i><b>ark.mobile.wiki.jsoup</b></i></p>}
     ...
     * <p>
     * Note that this method should not be used to clean user-submitted HTML; rather, use {@link ark.mobile.wiki.jsoup.safety.Cleaner} to clean HTML.
     * @return this, for chaining
     * @see Element#empty()
     * @see #empty()
     */
