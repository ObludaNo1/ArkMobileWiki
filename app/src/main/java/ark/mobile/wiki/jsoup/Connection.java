...
public interface Connection {
     ...
     * "ark.mobile.wiki.jsoup", "language", "Java", "language", "English");</code> creates a query string like:
     * <code>{@literal ?name=ark.mobile.wiki.jsoup&language=Java&language=English}</code>
