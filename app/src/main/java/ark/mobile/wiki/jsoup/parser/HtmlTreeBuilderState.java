            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    if (name.equals("html")) {
                        ...
                        // ark.mobile.wiki.jsoup special: update base the frist time it is seen
                        ...
                        // else if noscript && scripting flag = true: rawtext (ark.mobile.wiki.jsoup doesn't run script, to handle as noscript)
                        tb.insert(start);
