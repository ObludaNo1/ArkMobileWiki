package ark.mobile.wiki.jsoup.internal;
...
/**
 * A ark.mobile.wiki.jsoup internal class (so don't use it as there is no contract API) that enables constraints on an Input Stream,
