package ark.mobile.wiki.jsoup;

import ark.mobile.wiki.jsoup.nodes.Document;
import ark.mobile.wiki.jsoup.parser.Parser;
import ark.mobile.wiki.jsoup.safety.Cleaner;
import ark.mobile.wiki.jsoup.safety.Whitelist;
import ark.mobile.wiki.jsoup.helper.DataUtil;
import ark.mobile.wiki.jsoup.helper.HttpConnection;
...
/**
 The core public access point to the ark.mobile.wiki.jsoup functionality.
...
public class Jsoup {
     ...
     * Use examples:
     * <ul>
     *  <li><code>Document doc = Jsoup.connect("http://example.com").userAgent("Mozilla").data("name", "ark.mobile.wiki.jsoup").get();</code></li>
