...
import ark.mobile.wiki.jsoup.nodes.Comment;
import ark.mobile.wiki.jsoup.nodes.Document;
import ark.mobile.wiki.jsoup.nodes.DocumentType;
import ark.mobile.wiki.jsoup.nodes.Element;
import ark.mobile.wiki.jsoup.nodes.Node;
import ark.mobile.wiki.jsoup.nodes.PseudoTextElement;
import ark.mobile.wiki.jsoup.nodes.TextNode;
import ark.mobile.wiki.jsoup.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static ark.mobile.wiki.jsoup.internal.Normalizer.lowerCase;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<ark.mobile.wiki.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (ark.mobile.wiki.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    ark.mobile.wiki.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
