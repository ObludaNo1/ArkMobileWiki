...
/**
 * Parses HTML into a {@link ark.mobile.wiki.jsoup.nodes.Document}. Generally best to use one of the  more convenient parse methods
 * in {@link ark.mobile.wiki.jsoup.Jsoup}.
 */
public class Parser {
